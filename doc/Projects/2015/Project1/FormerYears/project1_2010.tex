...
\section*{Project 1, deadline Monday 13 september 12am (midnight)}
...
\item Finally, we provide at the lab a library package
...
For Fortran uses you could also try to use the inbuilt function \lstinline{a=MATMUL(b,c)} and see if that runs
faster than your algorithm.
