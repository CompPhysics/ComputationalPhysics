...
\]
with $\alpha\in [1,2]$. We will here follow the analysis made by \href{{http://www.sciencedirect.com/science/article/pii/S0378437104004327}}{Patriarca *et al*}. 
...
\begin{equation*}
  ...
  If you have time, see if you can extract a parametrization of the above curves, see for example \href{{http://www.sciencedirect.com/science/article/pii/S0378437104004327}}{Patriarca *et al*}. 
...
\begin{itemize}
   \item \href{{http://www.sciencedirect.com/science/article/pii/S0378437104004327}}{Patriarca \emph{et al}, Physica A \textbf{340}, 334 (2004)}
\end{itemize}
