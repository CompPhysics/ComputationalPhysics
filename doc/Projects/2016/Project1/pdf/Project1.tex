...
{\LARGE\bf
\begin{spacing}{1.25}
Project 1, deadline  September 12
\end{spacing}
}
\end{center}
...
\begin{equation*}
   \hat{A}\hat{v} = \tilde{\hat{b}},
\end{equation*}
where $\hat{A}$ is an $n\times n$  tridiagonal matrix which we rewrite as
...
We can rewrite our matrix $\hat{A}$ in terms of one-dimensional vectors $a,b,c$  
of length $1:n$. 
