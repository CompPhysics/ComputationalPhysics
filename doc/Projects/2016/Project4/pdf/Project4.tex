...
parallelize the code using either MPI (recommended) or OpenMP. Use optimization flags when compiling. Perform a timing analysis of some selected runs in order to see that you get an optimal speedup when parallelizing your code. 
...
\begin{verbatim}
mpic++ -O3 -o executable program.cpp
\end{verbatim}
if you use c++ (alternatively mpicxx) and
\begin{verbatim}
mpif90 -O3 -o executable program.f90
\end{verbatim}
...
\begin{verbatim}
clang-omp++ -O3 -fopenmp -o <executable>  <nameofprogram>
\end{verbatim}
