...
int main()
{
  ...
  //  W(0,0) = 0.25; W(0,1) = 1./9.; W(0,2) = 0.375; W(0,3) = 1./3.;   
  //W(1,0) = 0.5; W(1,1) = 2./9.; W(1,2) = 0.0; W(1,3) = 1./3.;   
  //W(2,0) = 0.0; W(2,1) = 1./9.; W(2,2) = 0.375; W(2,3) = 0.0;   
  //W(3,0) = 0.25; W(3,1) = 5./9.; W(3,2) = 0.25; W(3,3) = 1./3.;   
