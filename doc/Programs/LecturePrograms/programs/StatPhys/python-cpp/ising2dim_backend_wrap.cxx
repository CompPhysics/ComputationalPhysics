...
/*-----------------------------------------------
              @(target):= _ising2dim_backend.so
  ------------------------------------------------*/
#define SWIG_init    init_ising2dim_backend

#define SWIG_name    "_ising2dim_backend"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_monteCarlo(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg7 = &temp7;
  arg8 = &temp8;
  if (!PyArg_ParseTuple(args,(char *)"OOO:monteCarlo",&obj0,&obj1,&obj2)) SWIG_fail;
  ecode1 = SWIG_AsVal_double(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "monteCarlo" "', argument " "1"" of type '" "double""'");
  } 
  arg1 = static_cast< double >(val1);
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "monteCarlo" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  ecode3 = SWIG_AsVal_int(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "monteCarlo" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = static_cast< int >(val3);
  monteCarlo(arg1,arg2,arg3,*arg4,*arg5,*arg6,*arg7,*arg8);
...
static PyMethodDef SwigMethods[] = {
	 { (char *)"monteCarlo", _wrap_monteCarlo, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
